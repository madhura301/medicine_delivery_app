...
namespace MedicineDelivery.Infrastructure.Migrations
{
    ...
    [Migration("20260705145611_AddBusinessNameAndRazorpayBusinessTypeToChemistPayoutAccounts")]
    partial class AddBusinessNameAndRazorpayBusinessTypeToChemistPayoutAccounts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MedicineDelivery.Domain.Entities.ChemistActivationPayment", b =>
                {
                    ...
                    b.Property<string>("PaymentLinkShortUrl")
                        .HasMaxLength(500)
            ...
            modelBuilder.Entity("MedicineDelivery.Domain.Entities.ChemistPayoutAccount", b =>
                {
                    ...
                    b.Property<string>("OnboardingError")
                        .HasMaxLength(1000)
                    ...
                    b.Property<int>("RazorpayBusinessType")
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("RazorpayProductConfigurationId")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");
                    ...
                    b.HasIndex("RazorpayLinkedAccountId");

                    b.ToTable("ChemistPayoutAccounts");
                });

            modelBuilder.Entity("MedicineDelivery.Domain.Entities.Consent", b =>
                {
            ...
            modelBuilder.Entity("MedicineDelivery.Domain.Entities.ConsentLog", b =>
                {
            ...
            modelBuilder.Entity("MedicineDelivery.Domain.Entities.Order", b =>
                {
                    ...
                    b.Property<string>("OrderBillFileLocation")
                        .HasMaxLength(255)
                        .HasColumnType("character varying(255)");
            ...
            modelBuilder.Entity("MedicineDelivery.Domain.Entities.PaymentSplit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<decimal>("ChemistAmount")
                        .HasColumnType("decimal(10,2)");

                    b.Property<string>("ChemistLinkedAccountId")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");
                    ...
                    b.Property<decimal>("PharmaishAmount")
                        .HasColumnType("decimal(10,2)");
                    ...
                    b.Property<decimal>("TotalCaptured")
                        .HasColumnType("decimal(10,2)");
            ...
            modelBuilder.Entity("MedicineDelivery.Domain.Entities.RazorpayOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MedicineDelivery.Domain.Entities.UserOtp", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MedicineDelivery.Domain.Entities.ConsentLog", b =>
                {
                    b.HasOne("MedicineDelivery.Domain.Entities.Consent", "Consent")
                        .WithMany("ConsentLogs")
                        .HasForeignKey("ConsentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MedicineDelivery.Domain.Entities.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("MedicineDelivery.Domain.Entities.Order", b =>
                {
                    ...
                    b.HasOne("MedicineDelivery.Domain.Entities.Delivery", null)
                        .WithMany()
