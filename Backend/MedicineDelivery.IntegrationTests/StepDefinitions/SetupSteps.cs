...
public class SetupSteps
{
    ...
    [Given(@"I call the endpoint to map roles to permissions")]
    public async Task GivenICallTheEndpointToMapRolesToPermissions()
    {
        var response = await _context.Client.PostAsync("/api/setup/role-permissions/predefined", null);
        response.EnsureSuccessStatusCode();
    }
