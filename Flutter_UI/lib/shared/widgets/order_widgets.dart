                  ...
                  children: [
                    Expanded(
                      child: _buildNewOrderCard(
                        ...
                        onTap: () => AppHelpers.navigateToUploadPrescription(context),
                      ),
                    ),
                    ...
                    Expanded(
                      child: _buildNewOrderCard(
                        ...
                        onTap: () =>  AppHelpers.navigateToCameraPrescription(context),
                      ),
                    ),
                  ],
                ),
                  ...
                  children: [
                    Expanded(
                      child: _buildNewOrderCard(
                        ...
                        onTap: () => AppHelpers.navigateToVoiceOrder(context),
                      ),
                    ),
                    const SizedBox(width: 10),
                    Expanded(
